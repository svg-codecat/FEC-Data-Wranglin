...
class DataFetcher:
    ...
    def gimmie_data(self, sleep_timer: int = 30, record_limit: int = None):
        """
    ...
    def _get_transactions_on_page(self):
        ...
        for item in self.info["results"]:
            try:
                if contributor_zip := item["contributor_zip"].isnumeric():
